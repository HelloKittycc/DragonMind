...
The backend requirements include `python-multipart` plus lightweight document parsers for local `.pdf`, `.docx`, `.pptx`, `.xlsx`, `.csv`, `.txt`, `.md`, and `.json` knowledge file uploads.
